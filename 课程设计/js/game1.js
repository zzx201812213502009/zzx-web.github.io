...
maze[rows] = new Array()
maze[0][0] = new Array(1,1,1,1,1,1,1,1)
maze[0][1] = new Array(0,0,0,0,0,1,0,1)
maze[1][0] = new Array(0,1,0,0,1,1,0,0)
maze[1][1] = new Array(1,0,1,0,0,0,1,1)
maze[2][0] = new Array(0,0,1,0,1,0,0,1)
maze[2][1] = new Array(1,0,1,1,0,1,0,1)
maze[3][0] = new Array(0,1,0,0,0,0,1,1)
maze[3][1] = new Array(1,0,1,0,1,1,0,1)
maze[4][0] = new Array(0,0,1,0,0,1,0,1)
maze[4][1] = new Array(1,1,0,1,0,1,0,1)
maze[5][0] = new Array(0,0,0,0,1,1,0,1)
maze[5][1] = new Array(1,0,1,0,0,0,1,1)
maze[6][0] = new Array(0,0,0,1,1,1,0,0)
maze[6][1] = new Array(0,1,0,1,0,0,1,1)
maze[7][0] = new Array(1,0,1,1,1,1,0,0)
maze[7][1] = new Array(0,0,0,0,0,1,1,1)
maze[8][0] = new Array(0,1,1,1,1,1,0,0)
maze[8][1] = new Array(1,0,0,0,0,1,0,1)
